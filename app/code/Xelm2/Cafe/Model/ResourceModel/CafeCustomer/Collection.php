<?php
namespace Xelm2\Cafe\Model\ResourceModel\CafeCustomer;
...
class Collection extends AbstractCollection
{
	...
	protected $_eventPrefix = 'xelm2_cafe_customer_collection';
	...
	{
		$this->_init('Xelm2\Cafe\Model\CafeCustomer', 'Xelm2\Cafe\Model\ResourceModel\CafeCustomer');
	}
