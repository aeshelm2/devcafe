...
{    
     ...
     * cafeOrder
     *
     * @var \Xelm2\Cafe\Model\CafeOrderFactory $cafeOrder
     */
    protected $cafeOrder;
     ...
     * customerSession
     *
     * @var \Xelm2\Cafe\Model\Customer\Session $customerSession
     */
    ...
    /**
     * 
     * @var \Xelm2\Cafe\Model\Order\ItemFactory
     */
    protected $orderItem;
     ...
     * __construct
     * 
     * @param \Xelm2\Cafe\Model\CafeOrderFactory $cafeOrder
     * @param \Xelm2\Cafe\Model\Customer\Session $customerSession
     * @param \Magento\Checkout\Model\Session $checkoutSession
     * @return void
     */
    public function __construct(
        \Xelm2\Cafe\Model\CafeOrderFactory $cafeOrder,
        \Xelm2\Cafe\Model\Customer\Session $customerSession,
        \Magento\Checkout\Model\Session $checkoutSession,
        \Xelm2\Cafe\Model\Order\ItemFactory $orderItem
    )
    {
