<?php
namespace Techxspace\Cafe\Model\ResourceModel;
...
class CafeOrder extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
	...
	public function loadByCustomerId(\Techxspace\Cafe\Model\CafeOrder $cafeOrder, $customerId)
	{
	...
	public function loadByQuoteId(\Techxspace\Cafe\Model\CafeOrder $cafeOrder, $quoteId)
	{
        $connection = $this->getConnection();
