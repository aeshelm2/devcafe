<?php
namespace Techxspace\Cafe\Model\ResourceModel\CafeOrder;
...
class Collection extends AbstractCollection
{
	...
	protected $_eventPrefix = 'techxspace_cafe_order_collection';
	...
	{
		$this->_init('Techxspace\Cafe\Model\CafeOrder', 'Techxspace\Cafe\Model\ResourceModel\CafeOrder');
	}
