<?php
namespace Xclm2\Cafe\Model\ResourceModel\CafeOrder;
...
class Collection extends AbstractCollection
{
	...
	protected $_eventPrefix = 'xclm2_cafe_order_collection';
	...
	{
		$this->_init('Xclm2\Cafe\Model\CafeOrder', 'Xclm2\Cafe\Model\ResourceModel\CafeOrder');
	}
