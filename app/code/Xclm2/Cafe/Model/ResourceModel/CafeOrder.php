...
class CafeOrder extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
	...
	public function loadByCustomerId(\Xclm2\Cafe\Model\CafeOrder $cafeOrder, $customerId)
	{
	...
	public function loadByQuoteId(\Xclm2\Cafe\Model\CafeOrder $cafeOrder, $quoteId)
	{
        $connection = $this->getConnection();
