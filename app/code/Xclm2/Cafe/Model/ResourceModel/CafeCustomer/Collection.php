<?php
namespace Xclm2\Cafe\Model\ResourceModel\CafeCustomer;
...
class Collection extends AbstractCollection
{
	...
	protected $_eventPrefix = 'xclm2_cafe_customer_collection';
	...
	{
		$this->_init('Xclm2\Cafe\Model\CafeCustomer', 'Xclm2\Cafe\Model\ResourceModel\CafeCustomer');
	}
